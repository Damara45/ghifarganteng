...
func GetDataMahasiswa(mahasiswa string) (data Mahasiswa) {
	surat := MongoConnect("nilai").Collection("mahasiswa")
	filter := bson.M{"npm": mahasiswa}
...
// func GetDataNilai(mahasiswa string) (data Mahasiswa) {
// 	user := MongoConnect("nilai").Collection("mahasiswa")
// 	filter := bson.M{"npm": mahasiswa}
